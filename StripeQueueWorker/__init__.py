...
def main(msg: func.QueueMessage) -> None:
    ...
    elif job_type == 'invoice.paid' and job_payload.get('billing_reason', None) != 'subscription_update' and job_payload['total'] != 0: # includes things like subscriptions (see Stripe subscription)
